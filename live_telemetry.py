...
class TelemetryDisplay:
    ...
    def display(self):
        ...
        try:
            # Title (1 line)
            self.stdscr.addstr(0, 0, "F1 22 RACE MONITOR - Press 'q' to quit", curses.A_BOLD | curses.color_pair(4))
            ...
            if max_y > current_y + 3:
                stats_y = max_y - 2
                packet_abbrevs = {"motion": "MOT", "session": "SES", "lap_data": "LAP", "event": "EVT", 
                                "participants": "PRT", "car_setups": "SET", "car_telemetry": "TEL", 
                                "car_status": "STA", "car_damage": "DMG"}
